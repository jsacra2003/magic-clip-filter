...
@click.option(
    "--description",
    default="AI Agent that is designed to surface the newest Google Trends in realtime",
    help="Description of the agent",
)
@click.option(
    "--source-packages",
    multiple=True,
    default=["./google_trends_agent"],
    help="Source packages to deploy. Can be specified multiple times (e.g., --source-packages=./app --source-packages=./lib)",
)
@click.option(
    "--entrypoint-module",
    default="google_trends_agent.agent_engine_app",
...
@click.option(
    "--requirements-file",
    default="google_trends_agent/app_utils/.requirements.txt",
