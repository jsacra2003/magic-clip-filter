...
Implement agent logic in `google_trends_agent/`. Use `make playground` for interactive testing. Iterate based on user feedback.
...
- **Model 404 errors**: Fix `GOOGLE_CLOUD_LOCATION` (e.g., `global` instead of `eu-west1`), not the model name.
